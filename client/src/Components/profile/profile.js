          ...
          <div className="profile-banner">
            ...
            <div className="profile-data">
              ...
              <div className="vertical-data">
                ...
                <h4>{udata2[0].posts ? udata2[0].posts.length : 0}</h4>
              </div>
              <div className="vertical-data">
                <p>
                ...
                <h4>
                  ...
                  {udata2[0].userfollowers ? udata2[0].userfollowers.length : 0}
                </h4>
              </div>
              <div className="vertical-data">
                <p>
                ...
                <h4>
                  {udata2[0].userfollowing ? udata2[0].userfollowing.length : 0}
                </h4>
              </div>
